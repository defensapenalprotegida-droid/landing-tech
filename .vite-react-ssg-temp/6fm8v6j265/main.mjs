...
const HeroSlide = ({ slide, isFirst, children }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative min-h-screen lg:min-h-[950px] flex items-center overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 -z-10", children: [
      /* @__PURE__ */ jsx("img", { src: slide.image, alt: "", "aria-hidden": true, className: "w-full h-full object-cover" }),
...
function normalizarRegionGoogle(regionGoogle) {
  ...
  const lowerInput = lower.replace("region ", "").replace("región ", "").replace(" region", "").replace(" región", "");
  const parcial = REGIONES_CHILE.find((r) => {
    const rLower = r.toLowerCase();
    return rLower.includes(lowerInput) || lowerInput.includes(rLower);
  });
  if (parcial) return parcial;
  const inicio = REGIONES_CHILE.find(
    (r) => r.toLowerCase().startsWith(lowerInput.slice(0, 4))
  );
...
const AddressSearchInput = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      apiError && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 mt-1 text-yellow-600 dark:text-yellow-500 text-xs", children: [
        /* @__PURE__ */ jsx(AlertCircle, { className: "w-3 h-3 flex-shrink-0" }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
          /* @__PURE__ */ jsx("span", { children: apiError }),
          apiError.includes("key") && /* @__PURE__ */ jsx("span", { className: "text-yellow-700 dark:text-yellow-400", children: "Ver docs/GOOGLE_MAPS_SETUP.md para configurar" })
        ] })
      ] })
    ] }),
