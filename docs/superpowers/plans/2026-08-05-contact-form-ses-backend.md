...
Parameters:
  ...
  InitialRecipients:
    ...
    Default: abogados@arteagayaldunate.cl
...
sam deploy --guided \
  ...
  --parameter-overrides Stage=prod SesFromEmail=no-responder@arteagayaldunate.cl InitialRecipients=abogados@arteagayaldunate.cl
```
...
2. El correo llega a `abogados@arteagayaldunate.cl` (revisar también spam) dentro de 1-2 minutos.
